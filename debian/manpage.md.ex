% libfprint(SECTION) | User Commands
%
% "March 29 2026"
...
libfprint - program to do something

# SYNOPSIS

**libfprint** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**libfprint** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **libfprint** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**libfprint** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    libfprint. See **foo.conf**(5) for further details.
...
**libfprint** provides some return codes, that can be used in scripts:
...
Shubham <shubham@unknown>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Shubham
